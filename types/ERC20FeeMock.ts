...
export interface ERC20FeeMockInterface extends utils.Interface {
  functions: {
    ...
    "setBasisPointsRate(uint256)": FunctionFragment;
    "setMaximumFee(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setBasisPointsRate",
...
export interface ERC20FeeMock extends BaseContract {
  contractName: "ERC20FeeMock";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20FeeMockInterface;
