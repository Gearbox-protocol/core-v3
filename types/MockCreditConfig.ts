...
export interface MockCreditConfigInterface extends utils.Interface {
  functions: {
...
export interface MockCreditConfig extends BaseContract {
  contractName: "MockCreditConfig";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockCreditConfigInterface;
