...
export interface ACLNonReentrantTraitTestInterface extends utils.Interface {
  functions: {
...
export interface ACLNonReentrantTraitTest extends BaseContract {
  contractName: "ACLNonReentrantTraitTest";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ACLNonReentrantTraitTestInterface;
