...
export interface BotsIntegrationTestInterface extends utils.Interface {
  functions: {
    ...
    "test_I_BOT_01_botMulticall_works_correctly()": FunctionFragment;
    "test_I_BOT_02_setBotPermissions_works_correctly()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_I_BOT_01_botMulticall_works_correctly"
      | "test_I_BOT_02_setBotPermissions_works_correctly"
      | "underlying"
      | "underlyingT"
      | "weth"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_I_BOT_01_botMulticall_works_correctly",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_I_BOT_02_setBotPermissions_works_correctly",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface BotsIntegrationTest extends BaseContract {
  contractName: "BotsIntegrationTest";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BotsIntegrationTestInterface;
