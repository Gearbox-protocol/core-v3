...
export interface PolicyManagerV3Interface extends utils.Interface {
  functions: {
...
export interface PolicyManagerV3 extends BaseContract {
  contractName: "PolicyManagerV3";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PolicyManagerV3Interface;
