...
export interface CollateralLogicHelperInterface extends utils.Interface {
  functions: {
    ...
    "saveCallOrder()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "saveCallOrder",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface CollateralLogicHelper extends BaseContract {
  contractName: "CollateralLogicHelper";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollateralLogicHelperInterface;
  ...
  functions: {
    ...
    saveCallOrder(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    saveCallOrder(overrides?: CallOverrides): Promise<PopulatedTransaction>;
