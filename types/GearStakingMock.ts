...
export interface GearStakingMockInterface extends utils.Interface {
  functions: {
    ...
    "setCurrentEpoch(uint16)": FunctionFragment;
...
export interface GearStakingMock extends BaseContract {
  contractName: "GearStakingMock";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GearStakingMockInterface;
