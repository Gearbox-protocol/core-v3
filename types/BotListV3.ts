...
export interface BotListV3Interface extends utils.Interface {
  functions: {
...
export interface BotListV3 extends BaseContract {
  contractName: "BotListV3";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BotListV3Interface;
