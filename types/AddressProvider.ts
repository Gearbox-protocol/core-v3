...
export interface AddressProviderInterface extends utils.Interface {
  functions: {
    ...
    "getPriceOracleV2()": FunctionFragment;
    ...
    "setPriceOracleV2(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getPriceOracleV2",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setPriceOracleV2",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface AddressProvider extends BaseContract {
  ...
  functions: {
    ...
    getPriceOracleV2(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    getPriceOracleV2(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getPriceOracleV2(overrides?: CallOverrides): Promise<PopulatedTransaction>;
