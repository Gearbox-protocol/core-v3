...
export interface CreditManagerV3Interface extends utils.Interface {
  functions: {
...
export interface CreditManagerV3 extends BaseContract {
  contractName: "CreditManagerV3";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CreditManagerV3Interface;
