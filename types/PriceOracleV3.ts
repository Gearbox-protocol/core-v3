...
export interface PriceOracleV3Interface extends utils.Interface {
  functions: {
...
export interface PriceOracleV3 extends BaseContract {
  contractName: "PriceOracleV3";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PriceOracleV3Interface;
