...
export interface IntegrationTestHelperInterface extends utils.Interface {
  functions: {
...
export interface IntegrationTestHelper extends BaseContract {
  contractName: "IntegrationTestHelper";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IntegrationTestHelperInterface;
