...
export interface CreditConfiguratorV3Interface extends utils.Interface {
  functions: {
...
export interface CreditConfiguratorV3 extends BaseContract {
  contractName: "CreditConfiguratorV3";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CreditConfiguratorV3Interface;
