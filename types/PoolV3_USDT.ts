...
export interface PoolV3_USDTInterface extends utils.Interface {
  functions: {
...
export interface PoolV3_USDT extends BaseContract {
  contractName: "PoolV3_USDT";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PoolV3_USDTInterface;
