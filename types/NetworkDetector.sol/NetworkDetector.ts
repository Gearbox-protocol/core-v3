...
export interface NetworkDetectorInterface extends utils.Interface {
  functions: {
    "IS_TEST()": FunctionFragment;
    "chainId()": FunctionFragment;
    "connectedNetworks(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "connectedNetworks",
...
export interface NetworkDetector extends BaseContract {
  contractName: "NetworkDetector";
