...
export interface CreditManagerV3Harness_USDTInterface extends utils.Interface {
  functions: {
...
export interface CreditManagerV3Harness_USDT extends BaseContract {
  contractName: "CreditManagerV3Harness_USDT";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CreditManagerV3Harness_USDTInterface;
