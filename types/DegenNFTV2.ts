...
export interface DegenNFTV2Interface extends utils.Interface {
  functions: {
...
export interface DegenNFTV2 extends BaseContract {
  contractName: "DegenNFTV2";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DegenNFTV2Interface;
