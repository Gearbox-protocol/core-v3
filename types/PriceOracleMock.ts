...
export interface PriceOracleMockInterface extends utils.Interface {
  functions: {
    ...
    "priceFeedsOrRevert(address)": FunctionFragment;
    "priceInUSD(address)": FunctionFragment;
    "setPrice(address,uint256)": FunctionFragment;
    "setRevertOnGetPrice(address,bool)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "priceFeedsOrRevert",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "priceInUSD",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setRevertOnGetPrice",
  ...
  decodeFunctionResult(functionFragment: "priceInUSD", data: BytesLike): Result;
