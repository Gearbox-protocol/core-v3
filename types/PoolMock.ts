...
export interface PoolMockInterface extends utils.Interface {
  functions: {
    ...
    "setCumulativeIndexNow(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setCumulativeIndexNow",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
...
export interface PoolMock extends BaseContract {
  ...
  functions: {
    ...
    setQuotaRevenue(
      _quotaRevenue: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    setVersion(
      ver: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
