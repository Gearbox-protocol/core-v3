...
export type PriceFeedConfigStructOutput = [string, string, number] & {
  token: string;
  priceFeed: string;
...
export interface TokensTestSuiteInterface extends utils.Interface {
  functions: {
    ...
    "listOf(uint8)": FunctionFragment;
    "listOf(uint8,uint8)": FunctionFragment;
    "listOf(uint8,uint8,uint8,uint8)": FunctionFragment;
    "listOf(uint8,uint8,uint8)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "listOf(uint8)"
      | "listOf(uint8,uint8)"
      | "listOf(uint8,uint8,uint8,uint8)"
      | "listOf(uint8,uint8,uint8)"
  ...
  encodeFunctionData(
    functionFragment: "listOf(uint8)",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "listOf(uint8,uint8)",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "listOf(uint8,uint8,uint8,uint8)",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "listOf(uint8,uint8,uint8)",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>
...
export interface TokensTestSuite extends BaseContract {
  ...
  functions: {
    ...
    "listOf(uint8)"(
      ...
      overrides?: CallOverrides
    ): Promise<[string[]] & { tokensList: string[] }>;
