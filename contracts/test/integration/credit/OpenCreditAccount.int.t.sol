...
contract OpenCreditAccountIntegrationTest is
    Test,
    ICreditManagerV3Events,
    ...
    CreditFacadeTestHelper
{
    ...
    function test_I_OCA_01_openCreditAccount_transfers_tokens_from_pool() public notExpirableCase {
    ...
    /// @dev I:[OCA-4B]: openCreditAccount reverts if user has no NFT for degen mode
    function test_I_FA_04B_openCreditAccount_reverts_for_non_whitelisted_account()
        public
        withDegenNFT
        notExpirableCase
    {
    ...
    /// @dev I:[OCA-4C]: openCreditAccount opens account and burns token
    function test_I_FA_04C_openCreditAccount_burns_token_in_whitelisted_mode() public withDegenNFT notExpirableCase {
    ...
    // // /// @dev I:[OCA-5]: openCreditAccount sets correct values
    ...
    /// @dev I:[OCA-7]: openCreditAccount and openCreditAccount reverts when debt increase is forbidden
    ...
    /// @dev I:[OCA-8]: openCreditAccount runs operations in correct order
    ...
    /// @dev I:[OCA-9]: openCreditAccount cant open credit account with hf <1;
    ...
    /// @dev I:[OCA-10]: decrease debt during openCreditAccount
    ...
    /// @dev I:[OCA-11A]: openCreditAccount reverts if met borrowed limit per block
    ...
    /// @dev I:[OCA-11B]: openCreditAccount reverts if amount < minAmount or amount > maxAmount
    ...
    function test_I_FA_46_openCreditAccount_reverts_on_expired_CreditFacade() public expirableCase {
