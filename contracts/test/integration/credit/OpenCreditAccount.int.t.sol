...
contract OpenCreditAccountIntegrationTest is IntegrationTestHelper, ICreditFacadeV3Events {
    ...
    //         MultiCall({
    //             target: address(creditFacade),
    //             callData: abi.encodeCall(ICreditFacadeV3Multicall.increaseDebt, (_maxDebt - _minDebt))
    //         }),
    //         MultiCall({
    //             target: address(creditFacade),
    //             callData: abi.encodeCall(ICreditFacadeV3Multicall.addCollateral, (underlying, DAI_ACCOUNT_AMOUNT))
    ...
    //     vm.prank(FRIEND);
    //     creditFacade.openCreditAccount(FRIEND, calls, 0);

    //     calls = MultiCallBuilder.build(
    //         MultiCall({
    //             target: address(creditFacade),
    //             callData: abi.encodeCall(ICreditFacadeV3Multicall.increaseDebt, (_minDebt + 1))
    //         }),
    //         MultiCall({
    //             target: address(creditFacade),
    //             callData: abi.encodeCall(ICreditFacadeV3Multicall.addCollateral, (underlying, DAI_ACCOUNT_AMOUNT))
