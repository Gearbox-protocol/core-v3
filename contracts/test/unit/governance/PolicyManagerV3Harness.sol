...
import {PolicyManagerV3, Policy, ReferenceData} from "../../../governance/PolicyManagerV3.sol";
...
contract PolicyManagerV3Harness is PolicyManagerV3 {
    ...
    function checkPolicy(bytes32 policyHash, bytes32 referenceHash, uint256 oldValue, uint256 newValue)
        external
        returns (bool)
    {
